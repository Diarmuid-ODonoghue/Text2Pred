...
relation_tags = {'VB', 'VBG', 'VBN', 'VBP', 'VBZ', 'VBD'}
...
def process_document(text): # full document
    global sentence_number
    global sentence_triples
    global sentence_triplesPP
    global set_of_raw_concepts
                ...
                if NextStep:
                    ...
                    if RunCheck and LeftSiblingLabel == "NP":
                        ...
                        for nod in leaves:
                            ...
                            tmp2 = checkLabelLeaf(tree, tmp)
                            poss_head_word = checkLabelLeaf(tree, nod) # test for , and & other odd labels
                            if isinstance(poss_head_word, str) and tmp2 != ",": # and "(" in tmp2:
                                    head_label = checkLabelLeaf(tree, nod[:-1]) #tmp2.label() in concept_tags: # NN, NNP, NNS, ...
                                    Subject = poss_head_word # checkLabelLeaf(tree, Subject)
                    else:
...
def processAllTextFiles():
    ...
    for fileName in txt_files:
        ...
        while text_chunk_start < len(full_document_list):
            ...
            process_document(documentSegment)
...
# process_document("John Smyth drove his new car but he crashed it. ")
# process_document("John Smyth drove his new car but he crashed it. It was a bad day for Jane Doe. \
#                Tom Sullivan was eating in Sunbury on Thames that day.")

#process_document("POLITICAL LEADERS PAST and present have paid tribute to David Trimble’s contribution to peace \
...
# process_document("The strongest rain ever recorded in India shut down the financial hub of Mumbai, snapped \
...
# process_document("John drove his new car but he crashed it.")
# process_document("The fourth Wells account moving to another agency is the packaged paper-products division of Georgia-Pacific Corp., which arrived at Wells only last fall. Like Hertz and the History Channel, it is also leaving for an Omnicom-owned agency, the BBDO South unit of BBDO Worldwide. BBDO South in Atlanta, which handles corporate advertising for Georgia-Pacific, will assume additional duties for brands like Angel Soft toilet tissue and Sparkle paper towels, said Ken Haldin, a spokesman for Georgia-Pacific in Atlanta.")
process_document("The Irish Times is an Irish daily broadsheet newspaper and online digital publication. It launched on 29 March 1859. The editor is Paul O'Neill. The deputy editor is Deirdre Veldon. It is published every day except Sundays. The Irish Times is considered a newspaper of record for Ireland.")
#processAllTextFiles()

from nltk.tree import *
tree_string = "(S (NP (DT The) (NNP Irish) (NNP Times)) (VP (VBZ is) (NP (NP (DT an) (JJ Irish) (JJ daily) (NN broadsheet) (NN newspaper)) (CC and) (NP (JJ online) (JJ digital) (NN publication)))) (. .))"
